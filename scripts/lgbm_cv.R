...
# PARA DEBUG
args = c('201909', '201911', '201905-202003-201805', '202001', '50', '0.001', '100', '0.01', '0.01', '0.01', '0.01', '1', '-', '50', '~/Documentos/maestria-dm/dm-eyf/datasets/paquete_premium_201906_202001.txt.gz', '~/Documentos/maestria-dm/dm-eyf/kaggle/lgbm_basico.csv')
...
if (  length(args) != 16) {
  ...
  6: learning rate: 0.01, 0.001, 0.0005, ...
  7: hojas: 50, 100, ...
  ...
  17: path de salida: '~/lgbm.csv'", call.=FALSE)
}
...
learning_rate = as.double(args[6])
...
undersampling = as.numeric(args[15])
